...
#ifndef XWALK_RUNTIME_BROWSER_RENDERER_HOST_PEPPER_PEPPER_ISOLATED_FILE_SYSTEM_MESSAGE_FILTER_H_
#define XWALK_RUNTIME_BROWSER_RENDERER_HOST_PEPPER_PEPPER_ISOLATED_FILE_SYSTEM_MESSAGE_FILTER_H_
...
class PepperIsolatedFileSystemMessageFilter
 ...
 private:
  ...
  std::string CreateCrxFileSystem();
...
#endif  // XWALK_RUNTIME_BROWSER_RENDERER_HOST_PEPPER_PEPPER_ISOLATED_FILE_SYSTEM_MESSAGE_FILTER_H_
