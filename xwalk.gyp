  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/browser/renderer_host/pepper/pepper_isolated_file_system_message_filter.cc',
        'runtime/browser/renderer_host/pepper/pepper_isolated_file_system_message_filter.h',
