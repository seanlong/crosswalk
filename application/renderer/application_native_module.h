...
class ApplicationNativeModule : public xwalk::extensions::XWalkNativeModule {
 public:
  explicit ApplicationNativeModule(v8::Handle<v8::Context> context);
 ...
 private:
  ...
  static void GetManifestCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  // Return main frame window object according to the routing id.
  static void GetWindowByIDCallback(const v8::FunctionCallbackInfo<v8::Value>&);

  ApplicationRendererController* controller_;
