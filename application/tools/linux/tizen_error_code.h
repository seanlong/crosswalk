...
#ifndef XWALK_APPLICATION_TOOLS_LINUX_TIZEN_ERROR_CODE_H_
#define XWALK_APPLICATION_TOOLS_LINUX_TIZEN_ERROR_CODE_H_
...
#endif  // XWALK_APPLICATION_TOOLS_LINUX_TIZEN_ERROR_CODE_H_
